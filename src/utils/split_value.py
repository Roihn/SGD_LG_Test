...
import pandas as pd
# Load your JSON data
with open('processed_dialogues_001_value.json', 'r') as f:
    data = json.load(f)
...
# Assuming your data is a list of objects, you could convert it to a pandas DataFrame for easier manipulation
    ...
    train.to_json(f'data/{i}/train_value.json', orient='records')
    test.to_json(f'data/{i}/test_value.json', orient='records')