...
def train(proportion=100):
    train_dataset = load_dataset('json', data_files=f'data/{proportion}/train_slot.json', split='train')
    val_dataset = load_dataset('json', data_files=f'data/{proportion}/test_slot.json', split='train')
    print(train_dataset)
    ...
    def compute_metrics(p):
        ...
        # with open(f"logs/{proportion}/evaluation_losses_slot.txt", "a") as f:
    ...
    print(eval_result)
    trainer.save_model(f"models/model_slot_{proportion}")
